...
class FilterModal extends StatefulWidget {
  ...
  const FilterModal({Key? key, required this.tagList, this.onTap}) : super(key: key);
                                    ...
                                    SizedBox(
                                      ...
                                      child: IgnorePointer(
                                        child: Checkbox(
                                          ...
                                          splashRadius: 5,
                                          onChanged: (_) {},
                                          value: value.selectedTagId.contains(e.id),
                                        ),
                                      ),
                                    ),
                                  ],
