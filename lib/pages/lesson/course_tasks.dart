                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text("${index + 1}. ${title ?? ""}"),
                                  Text(isDone ? "Дууссан" : "Хийгээгүй", style: GoodaliTextStyles.bodyText(context, textColor: GoodaliColors.grayColor)),
                                ],
                              ),
                            ),
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: isDone ? GoodaliColors.successColor : GoodaliColors.whiteColor,
                                border: Border.all(color: isDone ? GoodaliColors.successColor : GoodaliColors.borderColor, width: 2),
                              ),
                              child: Center(
                                child: Icon(
                                  Icons.check,
