              ...
              TweenAnimationBuilder<double>(
                ...
                tween: Tween<double>(
                  begin: 0,
                      ...
                      (provider.feelDetails.isEmpty
                          ? 1
                          : provider.feelDetails.length),
                ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          Text(
                                              removeHtmlTags(detail?.body ?? "",
                                                  placeholder:
                                                      'Та үүнийг хийгээд үз.'),
                ...
                child: Row(
                  ...
                  children: [
                    pageNumber != 1
                        ? CustomButton(
                            onPressed: () async {
                              await audioProvider.setPlayerState(
                    ...
                    CustomButton(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          provider.feelDetails.length == pageNumber
                              ? "Дуусгах"
                              : "Дараах",
                          style: GoodaliTextStyles.titleText(
                            context,
