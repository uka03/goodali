...
class _ReadTabbarState extends State<ReadTabbar> with AutomaticKeepAliveClientMixin<ReadTabbar> {
  @override
              ...
              children: [
                Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text("Бичвэр", style: TextStyle(color: MyColors.black, fontSize: 24, fontWeight: FontWeight.bold)),
                        GestureDetector(
                            onTap: () {
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            GestureDetector(
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const OnlineBook())),
              child: Container(
